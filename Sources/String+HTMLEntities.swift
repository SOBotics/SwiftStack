...
/**
 ...
 Source: [Wikipedia](https://en.wikipedia.org/wiki/List_of_XML_and_HTML_character_entity_references)
 */
...
internal extension String {
    ...
    public var stringByDecodingHTMLEntities : String {
         ...
         **Examples:**
         ...
         - parameter string: The numeric representation of the HTML entity to decode
         - parameter base: The base to used for the conversion
        ...
        */
         ...
         **Examples:**
         ...
         - parameter entity: The HTML entity that should be decoded
         
         - returns: The decoded `Character` or `nil` for invalid input
